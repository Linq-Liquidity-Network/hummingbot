...
from hummingbot.connector.exchange.upbit.upbit_order_status import UpbitOrderStatus
from hummingbot.connector.in_flight_order_base cimport InFlightOrderBase
from hummingbot.connector.exchange.upbit.upbit_exchange cimport UpbitExchange
from hummingbot.core.event.events import (OrderFilledEvent, TradeType, OrderType, TradeFee, MarketEvent)

cdef class UpbitInFlightOrder(InFlightOrderBase):
    def __init__(self,
                 ...
                 price: Decimal,
                 amount: Decimal,
                 initial_state: UpbitOrderStatus,
                 filled_size: Decimal,
    ...
    def is_done(self) -> bool:
        return self.status >= UpbitOrderStatus.DONE
    ...
    @classmethod
    def from_json(cls, market, data: Dict[str, Any]) -> UpbitInFlightOrder:
        return UpbitInFlightOrder(
            market,
    ...
    def from_upbit_order(cls,
                            ...
                            trading_pair: str,
                            price: float,
                            amount: float) -> UpbitInFlightOrder:
        return UpbitInFlightOrder(
            market,
            client_order_id,
            hash,
