...
class UpbitUserStreamTracker(UserStreamTracker):
    ...
    def __init__(self,
                 orderbook_tracker_data_source: UpbitAPIOrderBookDataSource,
                 upbit_auth: UpbitAuth):
        super().__init__()
    ...
    def data_source(self) -> UserStreamTrackerDataSource:
        if not self._data_source:
            self._data_source = UpbitAPIUserStreamDataSource(orderbook_tracker_data_source=self._orderbook_tracker_data_source,
